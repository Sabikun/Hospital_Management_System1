...
<div class="container">
	...
	<span>Hello simu !</span><span style="margin-left:350px">Hospital management System </span>
  	...
  	<div class="row">
		...
		<div class="col-sm-1">
			...
			<div style="background-color:white; width:500px; border-style:groove; border-color:#FF0099">
				<div style="background-color:#8A2BE2; width:494px; padding-top:1px; padding-bottom:1px;">
