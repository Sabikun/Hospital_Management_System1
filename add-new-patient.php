...
<html lang="en">
	...
	<body>
			...
			<div style="background-color:slateblue; width:500px; border-style:groove; border-color:#FF0099;">
				<div style="background-color:#EE82EE; width:494px; padding-top:1px; padding-bottom:1px;">
				<h3 style="color:#0000FF;"><b>Add New Patients</b></h3></div>
				 <hr>
<form method="post">
