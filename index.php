...
<script>
var blink_speed = 2000; var t = setInterval(function () { var ele = document.getElementById('blinker'); ele.style.visibility = (ele.style.visibility == 'hidden' ? '' : 'hidden'); }, blink_speed);
...
<div class="container">
	...
	<div class="row">
    	<div class="col-sm-12">
        	<div class="header bg-white">            		
            			<h3 style="background:#0000FF;padding:20px;color:#FFFFFF;margin:0px">
	...
	<span>Hello <?php echo $s['username']; echo " !";?></span>
                            ...
                            echo $new; 
							?></span></span>
						<span style="margin-left:100px">Hospital Management System</span>
    ...
    <div class="row">  
    	<div class="col-sm-12">
        	<div class="footer bg-white">
            	<div class="copyright">
                	<p align="center" style="padding-top:10px;">Copyright &copy; Hospital management System  2018 &nbsp;&nbsp;&nbsp;<span style="color:#CC0033">s.s.simutee13@gmail.com </span></p>
                </div>
            </div>
        </div>
    </div>
